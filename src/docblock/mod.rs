...
pub use tags::{
    ...
    extract_param_raw_type, extract_removed_version, extract_return_description,
    extract_return_type, extract_see_references, extract_throws_tags, extract_type_assertions,
