...
- **Inlay hints.** Spread arguments (`...$args`) no longer receive a misleading single-parameter-name hint. Only the spread argument is suppressed; surrounding positional arguments still get their hints.
